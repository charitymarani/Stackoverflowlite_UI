...
@qn.route('/questions', methods=['POST'])
@jwt_required
...
@qn.route('/questions', methods=['GET'])
...
@qn.route('/questions/<int:question_id>', methods=['GET'])
...
@qn.route('/questions/<int:question_id>',
          methods=['DELETE'])
@jwt_required
...
@qn.route('/questions/<int:question_id>/answers',
          methods=['POST'])
@jwt_required
